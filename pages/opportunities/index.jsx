    ...
    <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col justify-center gap-5 w-[90%] mx-auto my-10">
          ...
          <div className="flex items-center gap-5">
            ...
            <input
              ...
              className="inline-block w-[85%] outline-none leading-6 py-1 px-2 border border-gray-500 mt-1"
            />
      ...
      <section className="h-screen flex flex-col gap-5 w-[80%] mx-auto my-10">
        <nav className="flex gap-5 uppercase">
          <span className={projType==="lab"?activeNavClass:navClass} onClick={()=>{setProjType("lab")}}>lab based projects</span>
          <span className={projType==="btech"?activeNavClass:navClass} onClick={()=>{setProjType("btech")}}>b.tech projects</span>
          <span className={projType==="mtech"?activeNavClass:navClass} onClick={()=>{setProjType("mtech")}}>m.tech projects</span>
        </nav>
        <div className="h-[90vh] border-2">
        </div>
      </section>
    </div>
  );
